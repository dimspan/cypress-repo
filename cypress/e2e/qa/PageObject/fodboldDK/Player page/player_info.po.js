export class player_info_po{
    constructor(){
        this.widget_code = ".wff_widget.wff_widget_FW5473778E5A6585EF.wff_widget_wide"
        this.flag_logo_container = ".wff_flag_and_logo_container.wff_flag_and_logo_container_center"
        ...
        this.expected_stats_array = ["Navn","Alder","Nationalitet","Klub","Position","Landsholdstrøjenummer","Klubtrøjenummer","Vægt","Højde"]
        this.expected_data_array = ["Erling Haaland","23","Norge","Manchester City","Angriber","9","9","87 kg","194 cm"]
    ...
    check_player_name_and_logo(){
        ...
        cy.get(this.widget_code).within(()=>{
            ...
            .should("have.attr","style","min-width: 100px; width: 100px; height: 100px;")
            .and("have.css","min-width","100px")
            .and("have.css","width","100px")
            .and("have.css","height","100px")
            .and("have.css","margin-right","0px")

            //check the player name
            cy.checkTextSize(this.player_name,28)
