export class fodbold_incidents_po{
    constructor(){
        ...
        this.event_info_data = ".wff_event_info_data"
        this.label_text = ".wff_label_text"
        this.event_venue = ".wff_event_info_venue"
        this.referee = ".wff_event_info_referee"
        this.attendance = ".wff_event_info_attendance"
    }
    ...
    check_all_texts(){
        cy.get(this.incidents_widget).within(()=>{
            cy.WeightSize(".wff_participant_link","12px","400")
            cy.WeightSize(this.elapsed_time,"14px","700")
            cy.WeightSize(this.period_class,"14px","400")
            cy.get(this.event_info_data).within(()=>{
                cy.WeightSize(this.label_text,"14px","400")
                cy.WeightSize(this.event_venue,"14px","400")
                cy.WeightSize(this.referee,"14px","400")
                cy.WeightSize(this.attendance,"14px","400")
            })
        })
    }
}