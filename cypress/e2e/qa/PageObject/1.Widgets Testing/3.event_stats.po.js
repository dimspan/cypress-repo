export class ice_hockey_event_stats{
    constructor(){
        this.event_stats_code = '.wff_widget.wff_widget_FW8BA005F7AF739032.wff_widget_large.wff_event_stats_generic_icehockey'
        ...
        this.active_tab = ".wff_event_stats_scope.wff_active"
    ...
    check_text_elements(){  
        cy.get(this.event_stats_code).within(()=>{
            // team names 
            cy.WeightSize(this.participant_responsive_text,"14px","700")
    ...
    check_tabs_in_ev_stats(){
        cy.get(this.event_stats_code).within(()=>{
            ...
            for(var i = 4; i > -1; i--){
                ...
                .click()
                cy.get(this.active_tab).find(this.label_text)
