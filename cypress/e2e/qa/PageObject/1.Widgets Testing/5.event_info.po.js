export class ice_hockey_event_info_po{
    constructor(){
        this.event_info_code = ".wff_widget.wff_widget_FW899361658D83B935.wff_widget_large"
        ...
        this.round = ".wff_round.wff_break_small"
        this.participants = ".wff_participant_name.wff_responsive_text"
    }
    check_visual_elements(){
        ...
        cy.get(this.event_info_code).within(()=>{
            ...
            .should("be.visible")
            .and("have.css","background-image",'url("https://es-bimg.enetscores.com/img/sports_banners/event_info_icehockey_banner.webp")')
    ...
    check_texts(){
        cy.get(this.event_info_code).within(()=>{
            //stage text
            cy.stageName(this.stage_name,"ellipsis","block","hidden","400","uppercase","12px")
      
            //round text
            cy.WeightSize(this.round,"12px","400")
            cy.WeightSize(this.stage_name,"12px","400")
            cy.get(this.round)
            .should("be.visible")            
            .and("have.css","visibility","visible")
            cy.get(this.stage_name)
            .should("be.visible")
            .and("have.css","visibility","visible")
            //date
            cy.get(this.date)
            ...
            //team names
            cy.teamNames(this.participants,"hidden","none","none solid rgb(255, 255, 255)","rgb(255, 255, 255)","border-box","700","20px")
    ...
    check_tooltip(){
        cy.get(this.event_info_code).within(()=>{
            ...
            cy.zIndexPaddingDisplay(this.tooltip_class,"1","flex","70.75px","absolute","26px","8px 5px","center","default","15px","matrix(1, 0, 0, 1, 35.375, 0)")
