import {league_page_livescore_fixtures_po} from "../../../PageObject/danskeSpil/livescore_fixtures.po"
let po = new league_page_livescore_fixtures_po
let url = null;

describe('livescore fixtures tests on league page - Soccer', () => {
  ...
  context('Tests livescore fixtures on league page - Soccer', () => {
