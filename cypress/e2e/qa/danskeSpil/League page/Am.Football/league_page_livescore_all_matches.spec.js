...
describe('livescore results tests on league page - Am.Football', () => {
  ...
  context('Tests livescore all matches on league page - Am.Football', () => {

    it('C1 - livescore all matches widget exist - Am.Football', () => {
      cy.visit(url);
      
      po.livescore_results_exists()
    });

    it('C2 - livescore all matches all texts - Am.Football', () => {
      
      po.livescore_results_all_matches()
    });

    it('C3 - livescore all matches widget exist on mobile - Am.Football', () => {
