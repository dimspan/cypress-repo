...
describe('livescore results tests on league page - volleyball', () => {
  ...
  context('Tests livescore all matches on league page - volleyball', () => {

    it('C1 - livescore all matches widget exist - volleyball', () => {
      cy.visit(url);
      
      po.livescore_results_exists()
    });

    it('C2 - livescore all matches all texts - volleyball', () => {
      
      po.livescore_results_all_matches()
    });

    it('C3 - livescore all matches widget exist on mobile - volleyball', () => {
