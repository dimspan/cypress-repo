...
describe('Livescore tests on baseball front page', () => {
  ...
  context('Tests livescore on baseball front page', () => {
    ...
    it('C2 - Check livescore all texts - baseball', () => {
      //cy.visit(url);
      po.counter = 1
      po.livescore_all_matches()
    });

    it('C3 - Check livescore all texts on mobile - baseball', () => {
    ...
    it('C4 - Check all live matches on livescore widget - baseball', () => {
      
      po.livescore_live_matches();
    });

    it('C5 - Check all finished matches on livescore widget - baseball', () => {
      //cy.visit(url);
      po.counter = 1
    ...
    // it('C5 - Check if the team names have links - baseball', () => {
    //   cy.visit(url);
