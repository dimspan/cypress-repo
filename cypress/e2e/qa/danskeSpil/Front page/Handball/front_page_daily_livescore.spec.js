...
describe('Livescore tests on handball front page', () => {
  ...
  context('Tests livescore on handball front page', () => {

    it('C1 - Check livescore widget exist - handball', () => {
      cy.visit(url);
      //po.counter = 1
      po.daily_livescore_exists()
    });

    it('C2 - Check livescore all texts - handball', () => {
      //cy.visit(url);
      po.counter = 1
      po.livescore_all_matches()
    });

    it('C3 - Check livescore all texts on mobile - handball', () => {
    ...
    it('C4 - Check all live matches on livescore widget - handball', () => {
      
      po.livescore_live_matches();
    });

    it('C5 - Check all finished matches on livescore widget - handball', () => {
      //cy.visit(url);
      po.counter = 1
    ...
    // it('C5 - Check if the team names have links - handball', () => {
    //   cy.visit(url);
