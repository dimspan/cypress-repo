...
describe('Livescore tests on baseball front page', () => {
  ...
  context('Tests livescore on Am. football front page', () => {

    it('C1 - Check livescore widget exist - Am.Football', () => {
      cy.visit(url);
      //po.counter = 1
      po.daily_livescore_exists()
    });

    it('C2 - Check livescore all texts - Am.Football', () => {
      
      po.counter = 1
      po.livescore_all_matches()
    });

    it('C3 - Check livescore all texts on mobile - Am.Football', () => {
    ...
    it('C4 - Check all live matches on livescore widget - Am.Football', () => {
      
      po.livescore_live_matches();
    });

    it('C5 - Check all finished matches on livescore widget - Am.Football', () => {
      //cy.visit(url);
      po.counter = 1
    ...
    // it('C5 - Check if the team names have links - Am.Football', () => {
    //   cy.visit(url);
