...
describe('Livescore widgets on premier league pl page', () => {
  ...
  before(() => {
    cy.clearCookies()
                ...
                cy.wait(1000)
    url = 'https://fodbold.dk/spiller/737066/Erling-Haaland/klub/20720/Premier-League';
  ...
  context('PC view tests results livescore premier league', () => {
    it('C1 - Check last matches player page', () => {
        cy.visit(url);
    ...
    it("C2 - Check the livescore fixtures premier league",()=>{
