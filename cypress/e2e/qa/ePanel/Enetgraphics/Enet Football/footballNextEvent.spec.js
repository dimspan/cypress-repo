...
describe('[FB]Test the design and functionalities of EG footballNextEvent ',
{
    retries: {
      runMode: 0,
      openMode: 0,
...
() =>{
    ...
    beforeEach(()=>{
        ...
        po.selectedTemplate = ' EG Football Next Event '
        ...
        '.ep_ig_edditable_component:eq(6)']
        evpo.highlightedEditableAreasCount = 7
        evpo.editableElementsCount = 7

        context('[FB]PC view tests Next Event', () =>{    
            ...
            it('[FB]C2 - Get to the EG Football Next Event template',()=>{
                po.openExactGraphic()
                // cy.wait(1000)
            ...
            it('[FB]C3 - Check the design of the texts in the selected template',()=>{
                po.footballNextEventTemplDesign()
            })
