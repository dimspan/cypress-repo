...
describe('[FB]Test the design and functionalities of EG Football singlePlayerStats',
{
    retries: {
      runMode: 0,
      openMode: 0,
...
() =>{
    ...
    beforeEach(()=>{
        ...
        context('[FB]PC view tests Player stats', () =>{    
            ...
            it('[FB]C2 - Get to the EG Football Single Event Player Stats template',()=>{
                po.openExactGraphic()
                // cy.wait(1000)
            ...
            it('[FB]C3 - Check the design of the texts in the selected template',()=>{
                po.footballSinglePlayerStatsTemplDesign()
            })
