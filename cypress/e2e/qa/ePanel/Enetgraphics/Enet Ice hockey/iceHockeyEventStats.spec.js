...
describe('Test the design and functionalities of EG Ice hockey eventStats',
{
    retries: {
      runMode: 0,
      openMode: 0,
...
() =>{
    ...
    beforeEach(()=>{
        ...
        po.selectedTemplate = ' EG Ice Hockey Event Stats '
        ...
        '.ep_ig_edditable_component:eq(23)','.ep_ig_edditable_component:eq(24)','.ep_ig_edditable_component:eq(25)']
        evpo.highlightedEditableAreasCount = 26
        evpo.editableElementsCount = 26

        datapo.eventTypedName = "Boston Bruins-New York Rangers"
        datapo.textTypedInEventField = "Boston Bruins-New York Rangers "
        datapo.typedText = ["Period 1","NHL Preseason (USA)","2023/2024","Bulgarian","dd.mm.yy"]
        datapo.fistElementInLoop = 5
        datapo.tourTempDropdownIndex = 5
        datapo.langDropdownIndex = 8
        datapo.languageTypedIndex = 3
        datapo.statHeaderExpText = "Бостън Бруинс"
        datapo.statHeaders = '#home-name'

        context('PC view tests EG Event Stats', () =>{    
            ...
            it('C2 - Get to the EG Ice hockey Event Stats template',()=>{
                po.openExactGraphic()
                // cy.wait(1000)
            ...
            it('C3 - Check the design of the texts in the selected template',()=>{
                po.iceHockeyEventStatsTemplateDesign()
            })
