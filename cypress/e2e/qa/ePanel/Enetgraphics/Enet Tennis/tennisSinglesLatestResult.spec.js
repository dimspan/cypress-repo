...
describe('Test the design and functionalities of EG tennisSinglesLatestResult',
{
    retries: {
      runMode: 0,
      openMode: 0,
...
() =>{
    ...
    beforeEach(()=>{
        ...
        po.selectedTemplate = ' EG Tennis Singles Latest Result '
        ...
        datapo.lastElementInLoop = 7
        datapo.tourTempDropdownIndex = 5
        datapo.langDropdownIndex = 6
        ...
        datapo.eventsNameHeaders = '#participant-name'
        datapo.eventsNameHeadersExpText = 'Novak Djokovič'
        ...
        context('PC view tests Player Event Stats', () =>{    
            ...
            it('C3 - Check the design of the texts in the selected template',()=>{
                po.tennisSinglesLatestResultTemplDesign()
            })
