...
describe('Test the design and functionalities of EG tennisSinglePlayerStats',
{
    retries: {
      runMode: 0,
      openMode: 0,
...
() =>{
    ...
    beforeEach(()=>{
        ...
        po.selectedTemplate = ' EG Tennis Single Player Stats '
        ...
        context('PC view tests Player stats', () =>{    
            ...
            it('C2 - Get to the EG Tennis Single Player Stats template',()=>{
                po.openExactGraphic()
                // cy.wait(1000)
            ...
            it('C3 - Check the design of the texts in the selected template',()=>{
                po.tennisSinglePlayerStatsTemplDesign()
            })
