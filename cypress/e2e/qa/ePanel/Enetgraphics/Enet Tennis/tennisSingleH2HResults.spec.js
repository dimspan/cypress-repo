...
describe('Test the design and functionalities of EG Tennis singleH2H',
{
    retries: {
      runMode: 0,
      openMode: 0,
...
() =>{
    ...
    beforeEach(()=>{
        ...
        h2hpo.elArray = ['.ep_ig_edditable_component:eq(0)','.ep_ig_edditable_component:eq(1)','.ep_ig_edditable_component:eq(2)','.ep_ig_edditable_component:eq(3)','.ep_ig_edditable_component:eq(4)','.ep_ig_edditable_component:eq(5)',
            ...
            '.ep_ig_edditable_component:eq(18)','.ep_ig_edditable_component:eq(19)','.ep_ig_edditable_component:eq(20)','.ep_ig_edditable_component:eq(21)','.ep_ig_edditable_component:eq(22)','.ep_ig_edditable_component:eq(23)']
        h2hpo.highlightedEditableAreasCount = 24
        ...
        context('PC view tests H2H', () =>{    
            ...
            it('C2 - Get to the EG Tennis Single H2H Results template',()=>{
                po.openExactGraphic()
                // cy.wait(1000)
