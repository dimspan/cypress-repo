// LS Football Player Rating - rating box is over player name https://enetpulse.atlassian.net/browse/LG-499
import { lg499_po } from "../../../PageObject/ePanel/bugs_pageObject/bugs.po";
...
let po = new lg499_po;
let url = null;
describe("All templates - Player name is visible", 
    {
    //     retries: {
    //     runMode: 2,
    //     openMode: 1,
    ...
    ()=>{
        ...
        context("PC view tests LG-499",()=>{
            ...
            it("C4 - LS Football Player Rating ",()=>{
                ...
                hopo.onlyLogin()
                po.checkIfThePlayerNameIsVisible()
