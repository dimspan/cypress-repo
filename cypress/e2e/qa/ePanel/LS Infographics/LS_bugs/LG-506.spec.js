// LS Football Player Rating - the infographic not showing correct logo https://enetpulse.atlassian.net/browse/LG-506
import { lg506_po } from "../../../PageObject/ePanel/bugs_pageObject/bugs.po";
...
let po = new lg506_po;
let url = null;
describe("All templates - The right logos for club and national teams", 
    {
    //     retries: {
    //     runMode: 2,
    //     openMode: 1,
    ...
    ()=>{
        ...
        context("PC view tests LG-506",()=>{
            ...
            it("C4 - LS Football Player Rating ",()=>{
                ...
                hopo.onlyLogin()
                po.checkThePlayerClubOrNationalLogo()
