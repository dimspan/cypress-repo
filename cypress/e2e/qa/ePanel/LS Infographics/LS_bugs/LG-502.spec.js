// LS Football Player Rating - date format “d month yyyy” shows label https://enetpulse.atlassian.net/browse/LG-502
import { lg502_po } from "../../../PageObject/ePanel/bugs_pageObject/bugs.po";
...
let po = new lg502_po;
let url = null;
describe("All templates - Missing label of a certain date format", 
    {
    //     retries: {
    //     runMode: 2,
    //     openMode: 1,
    ...
    ()=>{
        ...
        context("PC view tests LG-502",()=>{
            ...
            it("C4 - LS Football Player Rating ",()=>{
                ...
                hopo.onlyLogin()
                po.checkForMissingLabelOfDateFormat()
