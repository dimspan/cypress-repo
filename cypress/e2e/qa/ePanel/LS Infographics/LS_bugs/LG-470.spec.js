// LS Football Player Event Stats - country flag not showing correct info  https://enetpulse.atlassian.net/browse/LG-470
import { lg470_po } from "../../../PageObject/ePanel/bugs_pageObject/bugs.po";
...
let po = new lg470_po;
let url = null;
describe("All templates - Check if the player's logo is his nationality and not the team country flag", 
    {
    //     retries: {
    //     runMode: 2,
    //     openMode: 1,
    ...
    ()=>{
        ...
        context("PC view tests LG-470",()=>{
            ...
            //     po.checkHighlightedBackground()
            //     po.switchDimensions()            })
            it("C4 - LS Football Player Event Stats ",()=>{
                cy.visit("https://epanel.enetsites.com/infographic/infographic/33/0")
                hopo.onlyLogin()
                po.checkPlayerCountryFlag()
