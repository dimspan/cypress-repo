// LS Football Player Rating - wrong rating format https://enetpulse.atlassian.net/browse/LG-501
import { lg501_po } from "../../../PageObject/ePanel/bugs_pageObject/bugs.po";
...
let po = new lg501_po;
let url = null;
describe("All templates - The format of the player rating is correct", 
    {
    //     retries: {
    //     runMode: 2,
    //     openMode: 1,
