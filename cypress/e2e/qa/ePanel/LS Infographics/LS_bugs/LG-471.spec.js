// LS Football Player Event Stats - missing country flag border https://enetpulse.atlassian.net/browse/LG-471
import { lg471_po } from "../../../PageObject/ePanel/bugs_pageObject/bugs.po";
...
let po = new lg471_po;
let url = null;
describe("All templates - Check if the player's country flag has border", 
    {
    //     retries: {
    //     runMode: 2,
    //     openMode: 1,
    ...
    ()=>{
        ...
        context("PC view tests LG-471",()=>{
            ...
            it("C4 - LS Football Player Event Stats ",()=>{
                ...
                hopo.onlyLogin()
                po.checkPlayerCountryFlagHasBorder()
