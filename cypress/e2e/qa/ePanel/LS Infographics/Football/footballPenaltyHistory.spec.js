...
describe('Test the design and functionalities of LS Football penalty history',
{
    retries: {
      runMode: 0,
      openMode: 0,
...
() =>{
    ...
    beforeEach(()=>{
        ...
        po.selectedTemplate = ' LS Football Penalty History '
        po.firstPlayerName = "#player-name"
        po.title = '#penalty-history'
        evpo.elArray = ['.ep_ig_edditable_component:eq(0)','.ep_ig_edditable_component:eq(1)','.ep_ig_edditable_component:eq(2)','.ep_ig_edditable_component:eq(3)',
            '.ep_ig_edditable_component:eq(4)','.ep_ig_edditable_component:eq(5)']
        ...
        context('PC view tests LS Football Penalty history', () =>{    
            ...
            it('C2 - Get to the Football Penalty history template',()=>{
                po.openExactGraphic()
                // cy.wait(1000)
            ...
            it('C3 - Check the design of the texts in the selected template',()=>{
                po.lsFootballPenaltyHistoryTemplateDesign()
            })
