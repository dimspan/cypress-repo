...
describe('Test the design and functionalities of LS Football player rating h2h',
{
    retries: {
      runMode: 0,
      openMode: 0,
...
() =>{
    ...
    beforeEach(()=>{
        ...
        po.selectedTemplate = ' LS Football Player Rating H2H '
        po.firstPlayerName = "#player-name1"
        po.secondPlayerName = "#player-name2"
        po.playerRating = '.ep_ig_rating'
        po.eventName = '#teams1'
        ...
        context('PC view tests LS Football Player Rating h2h', () =>{    
            ...
            it('C2 - Get to the Football Player Rating template',()=>{
                po.openExactGraphic()
                // cy.wait(1000)
            ...
            it('C3 - Check the design of the texts in the selected template',()=>{
                po.lsFootballPlayerRatingH2HTemplateDesign()
            })
