...
describe('Test the design and functionalities of LS Football player rating',
{
    retries: {
      runMode: 0,
      openMode: 0,
...
() =>{
    ...
    beforeEach(()=>{
        ...
        po.selectedTemplate = ' LS Football Player Rating '
        ...
        evpo.highlightedEditableAreasCount = 4
        evpo.editableElementsCount = 4
        evpo.elArrayElem = 1
        ...
        context('PC view tests LS Football Player Rating', () =>{    
            ...
            it('C3 - Check the design of the texts in the selected template',()=>{
                po.lsFootballPlayerRatingTemplateDesign()
            })
