...
describe('[IH]Test the design and functionalities of LS iceHockeyMatchScore ',
{
    retries: {
      runMode: 0,
      openMode: 0,
...
() =>{
    ...
    beforeEach(()=>{
        ...
        po.selectedTemplate = ' LS Ice Hockey Match Score '
        ...
        '.ep_ig_edditable_component:eq(7)']
        evpo.highlightedEditableAreasCount = 8
        evpo.editableElementsCount = 8
        ...
        context('[IH]PC view tests Match score', () =>{    
            ...
            it('[IH]C2 - Get to the LS Ice Hockey Match Score template',()=>{
                po.openExactGraphic()
                // cy.wait(1000)
            ...
            it('[IH]C3 - Check the design of the texts in the selected template',()=>{
                po.lsIceHockeyMatchScoreTemplDesign()
            })
