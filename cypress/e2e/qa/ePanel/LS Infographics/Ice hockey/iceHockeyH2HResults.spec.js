...
describe('Test the design and functionalities of Ice hockey H2H results',
{
    retries: {
      runMode: 0,
      openMode: 0,
...
() =>{
    ...
    beforeEach(()=>{
        ...
        po.selectedTemplate = ' LS Ice Hockey H2H Results '
        ...
        '.ep_ig_edditable_component:eq(11)','.ep_ig_edditable_component:eq(12)','.ep_ig_edditable_component:eq(13)','.ep_ig_edditable_component:eq(14)']
        h2hpo.highlightedEditableAreasCount = 15
        h2hpo.editableElementsCount = 15
        ...
        context('PC view tests H2H', () =>{    
            ...
            it('C2 - Get to the LS Ice Hockey H2H Results template',()=>{
                po.openExactGraphic()
                // cy.wait(1000)
            ...
            it('C3 - Check the design of the texts in the selected template',()=>{
                po.lsIceHockeyH2HTemplateDesign()
            })
