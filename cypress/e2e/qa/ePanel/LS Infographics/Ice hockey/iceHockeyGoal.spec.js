...
describe('[IH]Test the design and functionalities of LS iceHockeyGoal ',
{
    retries: {
      runMode: 0,
      openMode: 0,
...
() =>{
    ...
    beforeEach(()=>{
        ...
        po.selectedTemplate = ' LS Ice Hockey Goal '
        ...
        '.ep_ig_edditable_component:eq(7)','.ep_ig_edditable_component:eq(8)']
        evpo.highlightedEditableAreasCount = 9
        evpo.editableElementsCount = 9
        impo.scalePopUpContainer = '.ep_ig_cropper_zoom_container.right_image'

        context('[IH]PC view tests LS Goal', () =>{    
            ...
            it('[IH]C2 - Get to the LS Ice Hockey Goal template',()=>{
                po.openExactGraphic()
                // cy.wait(1000)
