...
() =>{
    ...
    beforeEach(()=>{
        ...
        po.selectedTemplate = ' LS Ice Hockey Player Event Stats '
        po.firstTeam = '#event-home-name'
        po.secondTeam = '#event-away-name'
        po.firstTeamScore = '#event-home-result'
        po.secondTeamScore = '#event-away-result'
        ...
        '.ep_ig_edditable_component:eq(17)','.ep_ig_edditable_component:eq(18)','.ep_ig_edditable_component:eq(19)']
        evpo.highlightedEditableAreasCount = 20
        evpo.editableElementsCount = 20
        ...
        context('PC view tests Player Event Stats', () =>{    
            ...
            it('C3 - Check the design of the texts in the selected template',()=>{
                po.lsIceHockeyPlayerEventStatsTemplateDesign()
            })
